...
public final class TwitterTokenizer extends Tokenizer {
  ...
  private TwitterTokenizerImpl scanner;
  ...
  public static final int TWITTER_USER      = 9;
  public static final int TWITTER_HASHTAG   = 10;
  ...
  /**
   * Creates a new instance of the {@link TwitterTokenizer}.  Attaches
  ...
  private void init() {
    this.scanner = new TwitterTokenizerImpl(input);
  }
  ...
  public final boolean incrementToken() throws IOException {
    ...
    while(true) {
      ...
      if (tokenType == TwitterTokenizerImpl.YYEOF) {
        return false;
      }
      ...
      if (scanner.yylength() <= maxTokenLength) {
        ...
        if (tokenType == TwitterTokenizer.ACRONYM_DEP) {
          typeAtt.setType(TwitterTokenizer.TOKEN_TYPES[TwitterTokenizer.HOST]);
          termAtt.setLength(termAtt.length() - 1); // remove extra '.'
        } else {
          typeAtt.setType(TwitterTokenizer.TOKEN_TYPES[tokenType]);
        }
        return true;
      } else
